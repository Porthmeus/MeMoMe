...
class Test_annotationPerformance(unittest.TestCase):
    ...
    def test_ecoli_core_seed(self):
        ...
        self.assertLessEqual(
            exp,
            res,
            msg=f"Expected amount of annotated metabolites: {exp}, calculated amount of annotated metabolites: {res}. All three must be >=",
        )
    ...
    def test_ecoli_core_bigg_chebi(self):
        ...
        add_test_case_to_table(
            self.test_ecoli_core_bigg_chebi.__name__, res1 + res2, exp, mod
        )
        self.assertLessEqual(
            exp,
            res1 + res2,
            msg=f"Expected amount of annotated metabolites: {exp}, calculated amount of annotated metabolites: {res1 + res2}. All three must be >=",
        )
    ...
    def test_ecoli_vmh_bigg_id_chebi(self):
        mod_path = self.dat.joinpath("e_coli_vmh.xml")
        mod = MeMoModel.fromPath(mod_path)
        exp = AnnotationResult(486, 866, 358)
        res1 = AnnotationResult.fromAnnotation(annotateBiGG_id(mod.metabolites))
        res2 = AnnotationResult.fromAnnotation(annotateChEBI(mod.metabolites))
        add_test_case_to_table(
            self.test_ecoli_vmh_bigg_id_chebi.__name__, res1 + res2, exp, mod
        )
        self.assertLessEqual(
            exp,
            res1 + res2,
    ...
    def test_adlercreutzia_equolifaciens_chebi(self):
        ...
        res = AnnotationResult.fromAnnotation(annotateChEBI(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_chebi.__name__, res, exp, mod
        )
        self.assertLessEqual(
            exp,
            res,
    ...
    def test_adlercreutzia_equolifaciens_bigg(self):
        ...
        res = AnnotationResult.fromAnnotation(annotateChEBI(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_bigg.__name__, res, exp, mod
        )
        self.assertLessEqual(
            exp,
            res,
    ...
    def test_adlercreutzia_equolifaciens_bigg_id(self):
        ...
        res = AnnotationResult.fromAnnotation(annotateBiGG_id(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_bigg_id.__name__, res, exp, mod
        )
        self.assertLessEqual(
            exp,
            res,
    ...
    def test_adlercreutzia_equolifaciens_bigg_id_chebi(self):
        ...
        res2 = AnnotationResult.fromAnnotation(annotateChEBI(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_bigg_id_chebi.__name__,
            res1 + res2,
            exp,
            mod,
        )
    ...
    def test_adlercreutzia_equolifaciens_bigg_id_seed(self):
        ...
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_bigg_id_seed.__name__,
            res1 + res2,
            exp,
            mod,
        )
    ...
    def test_adlercreutzia_equolifaciens_seed(self):
        ...
        res = AnnotationResult.fromAnnotation(annotateModelSEED(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_seed.__name__, res, exp, mod
        )
        self.assertLessEqual(
            exp,
            res,
    ...
    def test_adlercreutzia_equolifaciens_seed_id(self):
        ...
        res = AnnotationResult.fromAnnotation(annotateModelSEED_id(mod.metabolites))
        add_test_case_to_table(
            self.test_adlercreutzia_equolifaciens_seed_id.__name__, res, exp, mod
        )
        self.assertLessEqual(
            exp,
            res,
...
def add_test_case_to_table(name: str, res, exp, mod: MeMoModel):
    ...
    table_data.append(
        [f"Inchis", *generate_value_row(res.annotated_inchis, exp.annotated_inchis)]
    )
    table_data.append(
        [f"DBs", *generate_value_row(res.annotated_dbs, exp.annotated_dbs)]
    )
    table_data.append(
        [f"Names", *generate_value_row(res.annotated_names, exp.annotated_names)]
    )
