...
class Test_MeMoMetabolite(unittest.TestCase):
    ...
    def test_sourceAnnotation(self):
        ...
        self.assertEqual(met3.annotations_source,{"test":["manual","model"], "test2":["no_dup"]})
        met3.add_inchi_string("InChI=1S/C6H12O6/c7-1-2-3(8)4(9)5(10)6(11)12-2/h2-11H,1H2/t2-,3-,4+,5-,6?/m1/s1", source = "pubchem")
