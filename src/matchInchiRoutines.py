...
def compareInchiByStringNoHydrogen(met1:str, met2:str) -> bool:
...
def compareInchiByStereoIsomer(met1:str, met2:str) -> bool:
...
def NeutraliseCharges(mol:rdkit.Chem.rdchem.Mol) -> rdkit.Chem.rdchem.Mol:
